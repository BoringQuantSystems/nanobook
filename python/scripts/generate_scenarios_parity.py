#!/usr/bin/env python3
"""Regenerate tests/reference/scenarios_parity.json from nanobook pure-Python audit path.

Run from repo root:
  cd nanobook/python && uv run python scripts/generate_scenarios_parity.py
"""
...
import nanobook.scenarios as ref  # noqa: E402

# Frozen reference uses pure-Python numpy draws (not Rust hot path).
ref._HAS_RUST_SCENARIOS = False
ref._rust_monte_carlo_native = None
ref._rust_monte_carlo_parity = None
        ...
        out_cases.append(
            {
                ...
                "summary": {
                    ...
                    "implied_median_annual_return": round(
                        float(ref_sum["implied_median_annual_return"]), 4
                    ),
