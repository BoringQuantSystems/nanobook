...
class IbkrBroker:
    ...
    def submit_order(self, symbol: str, side: str, quantity: int, order_type: str = "market", limit_price_cents: Optional[int] = None, client_order_id: Optional[str] = None, stop_price_cents: Optional[int] = None) -> int: ...
...
class Position:
    symbol: str
    quantity: float  # fractional shares, e.g. 0.4
    quantity_micro: int  # exact raw micro-shares (1 share = 1_000_000 units)
    quantity_whole: int  # truncated whole shares
    avg_entry_price: int
    total_cost: int
    realized_pnl: int
...
class Portfolio:
    def __init__(self, initial_cash: int, cost_model: CostModel, quantity_step: Optional[int] = None) -> None: ...
    @property
    def cash(self) -> int: ...
    @property
    def quantity_step(self) -> int: ...  # micro-shares; 1_000_000 = whole shares
    @quantity_step.setter
    def quantity_step(self, step: int) -> None: ...
    def set_quantity_step_fraction(self, fraction: float) -> None: ...
...
def py_backtest_weights(weight_schedule: List[List[Tuple[str, float]]], price_schedule: List[List[Tuple[str, int]]], initial_cash: int, cost_bps: int, periods_per_year: float = 252.0, risk_free: float = 0.0, stop_cfg: Optional[Dict[str, Any]] = None, fill_schedule: Optional[List[List[Tuple[str, Any]]]] = None) -> Dict[str, Any]: ...
...
def py_stoch(high: List[float], low: List[float], close: List[float], fastk_period: int, slowk_period: int, slowd_period: int) -> Tuple[List[float], List[float]]: ...
def py_stochf(high: List[float], low: List[float], close: List[float], fastk_period: int, fastd_period: int) -> Tuple[List[float], List[float]]: ...
def py_stochrsi(close: List[float], timeperiod: int, fastk_period: int, fastd_period: int) -> Tuple[List[float], List[float]]: ...
def py_plus_di(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_minus_di(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_dx(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_adx(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_cci(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_willr(high: List[float], low: List[float], close: List[float], period: int) -> List[float]: ...
def py_ultosc(high: List[float], low: List[float], close: List[float], period1: int, period2: int, period3: int) -> List[float]: ...
def py_mom(close: List[float], period: int) -> List[float]: ...
def py_roc(close: List[float], period: int) -> List[float]: ...
def py_rocp(close: List[float], period: int) -> List[float]: ...
def py_rocr(close: List[float], period: int) -> List[float]: ...
...
def py_adosc(high: List[float], low: List[float], close: List[float], volume: List[float], fast_period: int = 3, slow_period: int = 10) -> List[float]: ...
def py_natr(high: List[float], low: List[float], close: List[float], period: int = 14) -> List[float]: ...
def py_trange(high: List[float], low: List[float], close: List[float]) -> List[float]: ...
def py_list_supported_indicators() -> List[Dict[str, Any]]: ...
...
def backtest_weights(weight_schedule: List[List[Tuple[str, float]]], price_schedule: List[List[Tuple[str, int]]], initial_cash: int, cost_bps: int, periods_per_year: float = 252.0, risk_free: float = 0.0, stop_cfg: Optional[Dict[str, Any]] = None, fill_schedule: Optional[List[List[Tuple[str, Any]]]] = None) -> Dict[str, Any]: ...
