...
- **`py_backtest_weights` raises when a still-open lot has no positive fill or
  close price.** It no longer records a −100% week and then drops later
  returns. A true zero-equity bar still emits one return per period.
